...
public class ProductService {
    ...
    // return this.productRepository.findAll(ProductSpecification.minPrice(min), page);
    // }

    // case 2
    // public Page<Product> getProductWithSpecification(Pageable page, double max) {
    // return this.productRepository.findAll(ProductSpecification.maxPrice(max), page);
    // }

    // case 3
    // public Page<Product> getProductWithSpecification(Pageable page, String factory) {
    // return this.productRepository.findAll(ProductSpecification.matchFactory(factory),
    // page);
    // }
    ...
    // factory) {
    // return this.productRepository.findAll(ProductSpecification.matchListFactory(factory),
    // page);
    // }
